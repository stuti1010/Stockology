      ...
      >
       ...
       ✅ Account Management - Assistance with KYC, deposits, withdrawals, and more.</p>
        ...
        <div className=" md:w-1/2 flex flex-col items-center gap-8">
          ...
          <div className="relative w-20 h-20 md:w-32 md:h-32 flex justify-center items-center bg-gradient-to-r from-green-400 to-red-400 md:right-28">
            <div className="absolute inset-0 bg-gradient-to-r from-green-400 to-red-400 transform rotate-45 rounded-xl">
              <div className="w-full h-full bg-black bg-opacity-50 rounded-xl flex justify-center items-center">
                <motion.a
                  ...
                  className="flex items-center justify-center gap-3 text-white font-semibold px-6 py-3 rounded-lg  hover:scale-105 transition"
                  whileHover={{ scale: 1 }}
                >
          ...
          <div className="relative md:w-32 md:h-32 w-20 h-20 flex justify-center items-center mt-10 bg-gradient-to-r from-green-400 to-red-400 md:bottom-10">
            <div className="absolute inset-0 bg-gradient-to-r from-green-400 to-red-400 transform rotate-45 rounded-xl">
              <div className="w-full h-full bg-black bg-opacity-50 rounded-xl flex justify-center items-center">
                <motion.a
          ...
          <div className="relative md:w-32 md:h-32 w-20 h-20 flex justify-center items-center mt-10 bg-gradient-to-r from-green-400 to-red-400 md:bottom-12 md:right-20">
            <div className="absolute inset-0 bg-gradient-to-r from-green-400 to-red-400 transform rotate-45 rounded-xl">
              <div className="w-full h-full bg-black bg-opacity-50 rounded-xl flex justify-center items-center">
                <motion.a
                  href="#"
